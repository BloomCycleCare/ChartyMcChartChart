package com.bloomcyclecare.cmcc.ui.backup;
...
import com.bloomcyclecare.cmcc.ui.publish.PublishViewModel;
...
public class BackupFragment extends Fragment {
  ...
  public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
    mMainViewModel.updateTitle("App Backup");
    mMainViewModel.updateSubtitle("");

    View view = inflater.inflate(R.layout.fragment_cloud_backup, container, false);
